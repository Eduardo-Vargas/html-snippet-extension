  ...
  $(function() {
    ...
    $('#createButton').click(function(e) {
      ...
      if (this.mediaType === 'video') {
        ...
        demo.innerHTML =
          'Preview: <div style="overflow:hidden;padding-bottom:56.25%;position:relative;height:0;width=' +
          this.width +
        ...
        code.innerText =
          '<div style="overflow:hidden;padding-bottom:56.25%;position:relative;height:0;width=' +
          this.width +
          '%"> \n  <iframe \n style="left:0;top:0;height:100%;width:100%;position:absolute;" \n  width="420" \n height="315" \n src="https://www.youtube.com/embed/' +
          this.url +
          '" \n frameborder="0" \n allowfullscreen> \n </iframe> \n </div> ';
        ...
        var source =
          'https://img.youtube.com/vi/' + this.url + '/sddefault.jpg';
    ...
    $('#copyButton').click(function(e) {
      ...
      copyFrom.textContent = code.innerText;
      copyFrom.textContent = copyFrom.textContent.replace(
        /(\r\n\t|\n|\r\t)/gm,
        ''
      );
